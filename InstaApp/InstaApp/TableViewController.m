...
- (void)viewDidLoad {
    ...
    [self.tableView registerNib:nib forCellReuseIdentifier:@"CelulaInstagram"];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    TableViewCellXib *cell = [tableView dequeueReusableCellWithIdentifier:@"CelulaInstagram" forIndexPath:indexPath];
