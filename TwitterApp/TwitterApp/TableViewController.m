...
- (void)viewDidLoad {
    ...
    [self.tableView registerNib:nib forCellReuseIdentifier:@"CelulaTwitter"];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    TableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:@"CelulaTwitter" forIndexPath:indexPath];
